...
Composer install would throw random errors when installing dbal.  The fix was to remove the custum .gitattributes file and the refrence to the custom file from the .gitconfig. 

Removed and cleaned up files. Got rid of all the vim stuff.

Removed all mac specific stuff in an attempt to make this play nice with ubuntu.
